...
@synthesize step1Bkg, step2Bkg, step3Bkg, summaryBkg;
...
- (void)viewDidLoad
{
    ...
    step1Bkg.image = [UIImage imageNamed:@"step1.png"];
    step2Bkg.image = [UIImage imageNamed:@"step2.png"];
    step3Bkg.image = [UIImage imageNamed:@"step3top.png"];
    summaryBkg.image = [UIImage imageNamed:@"step3bottom.png"];
